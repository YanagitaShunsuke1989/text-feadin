...
var textAnime = document.getElementById("text-anime");
var splitText = _toConsumableArray(textAnime.innerHTML);
var wrapCharSpan = function wrapCharSpan() {
  return splitText.map(function (char) {
    return "<span>".concat(char, "</span>");
  }).join("");
};
